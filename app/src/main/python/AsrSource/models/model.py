...
class Model(nn.Module):
    ...
    def load(
        ...
        **kwargs,
        ...
        print('config_filename', config_filename, type(config_filename))
        ...
        print("model_cls",model_cls, type(model_cls))
        ...
        print("model_filename", model_filename, type(model_filename))
